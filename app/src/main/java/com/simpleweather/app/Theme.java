...
public class Theme {
    ...
    private static final int[] CARD_DARK = {0xFF1F2A36, 0xFF5C6B7A, 0xFF0061A4};
    private static final int[] CARD_LIGHT = {0xFFFFFFFF, 0xFFD9E2EC, 0xFFA2C8FF};

    /** 按卡片所在背景色返回 {primary, secondary, accent} */
    public static int[] cardTextColors(int bg) {
        return luma(bg) > 0.48f ? CARD_DARK : CARD_LIGHT;
    }
